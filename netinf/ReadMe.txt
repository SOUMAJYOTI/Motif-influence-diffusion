...
In addition, generate-nets is also provided. It allows to
build Kronecker and Forest-Fire networks and generate cascades. Please, run 
without any argument to see how to use them.